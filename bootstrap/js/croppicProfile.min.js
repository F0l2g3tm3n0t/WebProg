	...
	Croppic.prototype = {
		...
		bindImgUploadControl: function(){
			...
			that.form.find('input[type="file"]').change(function(){
				...
				$('#cropContainerEyecandy').show();			

				$.ajax({
                    url: 'http://localhost/kafra/user/savefileProfile',
                    data: formData,
					...
					if(response.status=='success'){
						...
						that.obj.append('<img src="http://senoirprojectcu.cloudapp.net/'+response.url+'">');
						that.initCropper();
						$('.uploadProfilePic').attr("disabled", true);
					...
					if(response.status=='small'){
						...
						that.obj.append('<div class="erb-image-wrapper"><img class="uploadImage" id ="'+response.actual_image_name+'" src="http://senoirprojectcu.cloudapp.net/'+response.url+'" style="margin:auto"></div>');
						that.initCropperSmall();
						//$('.uploadProfilePic').attr("disabled", true);
		...
		crop:function(){
			...
			$.ajax({
                url: 'http://localhost/kafra/user/cropFileProfile',
                data: formData,
                context: document.body,
                cache: false,
                contentType: false,
                ...
                type: 'POST'
					...
					if(response.status=='success'){
						...
						that.obj.append('<img class="croppedImg" src="http://localhost/kafra/user/'+response.url+'">');
